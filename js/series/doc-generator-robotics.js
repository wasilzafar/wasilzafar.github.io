...
Object.assign(DocGenerator, {
  ...
  generateRobotSpecWord: async function(filename, data) {
    ...
    return this.generateWord(filename, { title: 'Robot Specification Sheet â€” ' + (data.robotName || ''), author: 'Generated from wasilzafar.com', sections: sections });
  },
  ...
  generateRobotSpecPDF: function(filename, data) {
    var lines = [
      ...
      { text: ' ', size: 6 },
      { text: 'â”€â”€ GENERAL INFORMATION â”€â”€', size: 14, bold: true },
      { text: ' ', size: 4 },
      ...
      { text: ' ', size: 6 },
      { text: 'â”€â”€ PERFORMANCE SPECIFICATIONS â”€â”€', size: 14, bold: true },
      { text: ' ', size: 4 },
      ...
      { text: ' ', size: 6 },
      { text: 'â”€â”€ APPLICATIONS â”€â”€', size: 14, bold: true },
      { text: ' ', size: 4 },
      { text: data.applications || 'Not specified', size: 10 }
    ];
    if (data.notes) {
      lines.push({ text: ' ', size: 6 });
      lines.push({ text: 'â”€â”€ ADDITIONAL NOTES â”€â”€', size: 14, bold: true });
    ...
    var doc = new docx_lib.Document({
      sections: [{
        ...
        children: [
          ...
          new docx_lib.Paragraph({ children: [new docx_lib.TextRun({ text: 'Generated from wasilzafar.com â€” Robotics Business & Strategy', italics: true, size: 20, color: '3B9797' })], spacing: { after: 400 } }),
  ...
  generateBusinessStrategyPDF: function(filename, data) {
    ...
    pdf.text('Generated from wasilzafar.com â€” Robotics Business & Strategy', 20, 33);
    ...
    var doc = new docx_lib.Document({
      sections: [{
        ...
        children: [
          ...
          new docx_lib.Paragraph({ children: [new docx_lib.TextRun({ text: 'Generated from wasilzafar.com â€” Systems Integration & Deployment', italics: true, size: 20, color: '3B9797' })], spacing: { after: 400 } }),
  ...
  generateIntegrationPlanPDF: function(filename, data) {
    ...
    pdf.setFontSize(10);
    pdf.setTextColor(59, 151, 151);
    pdf.text('Generated from wasilzafar.com â€” Systems Integration & Deployment', 20, 33);
    pdf.setDrawColor(59, 151, 151);
    pdf.line(20, 37, 190, 37);
    var y = 50;
    var fields = [
    ...
    var doc = new docx_lib.Document({
      sections: [{
        ...
        children: [
          ...
          new docx_lib.Paragraph({ children: [new docx_lib.TextRun({ text: 'Generated from wasilzafar.com â€” Advanced & Emerging Robotics', italics: true, size: 20, color: '3B9797' })], spacing: { after: 400 } }),
  ...
  generateEmergingRobotPlanPDF: function(filename, data) {
    ...
    pdf.setFontSize(10);
    pdf.setTextColor(59, 151, 151);
    pdf.text('Generated from wasilzafar.com â€” Advanced & Emerging Robotics', 20, 33);
    pdf.setDrawColor(59, 151, 151);
    pdf.line(20, 37, 190, 37);
    var y = 50;
    var fields = [
    ...
    var doc = new docx_lib.Document({
      sections: [{
        ...
        children: [
          ...
          new docx_lib.Paragraph({ children: [new docx_lib.TextRun({ text: 'Generated from wasilzafar.com â€” Robotics & Automation Series', italics: true, size: 20, color: '3B9797' })], spacing: { after: 400 } }),
  ...
  generateSafetyPlanPDF: function(filename, data) {
    ...
    pdf.setFontSize(10);
    pdf.setTextColor(59, 151, 151);
    pdf.text('Generated from wasilzafar.com â€” Robotics & Automation Series', 20, 33);
    pdf.setDrawColor(59, 151, 151);
    pdf.line(20, 37, 190, 37);
    ...
    var doc = new docx_lib.Document({
      sections: [{
        ...
        children: [
          ...
          new docx_lib.Paragraph({ children: [new docx_lib.TextRun({ text: 'Gravity (m/sÂ²): ', bold: true }), new docx_lib.TextRun({ text: data.gravity || '9.81' })] }),
          ...
          new docx_lib.Table({
            rows: [
              new docx_lib.TableRow({ children: ['Link', 'Mass (kg), Length (m), CoM (m)', 'Inertia (kgÂ·mÂ²)'].map(function(h) { return new docx_lib.TableCell({ children: [new docx_lib.Paragraph({ children: [new docx_lib.TextRun({ text: h, bold: true, color: 'FFFFFF', size: 20 })] })], shading: { fill: '132440' }, width: { size: 33, type: docx_lib.WidthType.PERCENTAGE } }); }) }),
  ...
  generateDynamicsParamExcel: function(filename, data) {
    ...
    var configData = [
      ...
      [],
      ['Robot Name', data.robotName || 'N/A'],
      ['Gravity (m/sÂ²)', data.gravity || '9.81'],
  ...
  generateDynamicsParamPDF: function(filename, data) {
    ...
    pdf.text('Gravity: ' + (data.gravity || '9.81') + ' m/sÂ²', 20, y); y += 7;
  ...
  generateDHWorksheetWord: async function(filename, data) {
    ...
    var rows = [new docx_lib.TableRow({ children: ['Joint', 'Î¸ (deg)', 'd (m)', 'a (m)', 'Î± (deg)'].map(function(h) { return new docx_lib.TableCell({ children: [new docx_lib.Paragraph({ children: [new docx_lib.TextRun({ text: h, bold: true, color: 'FFFFFF', size: 20 })] })], shading: { fill: '132440' } }); }) })];
  ...
  generateDHWorksheetExcel: function(filename, data) {
    var header = ['Joint', 'Î¸ (deg)', 'd (m)', 'a (m)', 'Î± (deg)'];
    var rows = [header];
    for (var i = 1; i <= 6; i++) {
      var jv = data['joint' + i];
      if (jv && jv.trim()) {
  ...
  generateDHWorksheetPDF: function(filename, data) {
    ...
    pdf.setFontSize(10);
    var cols = ['Joint', 'Î¸ (deg)', 'd (m)', 'a (m)', 'Î± (deg)'];
